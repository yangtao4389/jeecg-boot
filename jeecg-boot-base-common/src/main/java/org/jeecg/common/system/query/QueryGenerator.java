...
public class QueryGenerator {
    ...
    public static <T> QueryWrapper<T> initQueryWrapper(T searchObj, Map<String, String[]> parameterMap) {
		...
		/*
		*  parameterMap--key:value = _t:[1583743766]
            parameterMap--key:value = column:[createTime]
            parameterMap--key:value = order:[desc]
            parameterMap--key:value = field:[id,,,date,uv,pv,ordernum,percent,carrierid,carriername,fakeordernum,action]
            parameterMap--key:value = pageNo:[1]
            parameterMap--key:value = pageSize:[10]
		*
		* */
        parameterMap.entrySet().forEach(entry -> log.info("parameterMap--key:value = " + entry.getKey() + ":" + Arrays.toString(entry.getValue())));
